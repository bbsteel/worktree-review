...
from worktree_review.schemas import (
    COMPUTE_POLICY_SCHEMA_ID,
    REVIEW_POLICY_SCHEMA_ID,
    load_schema,
)

REVIEW_POLICY_DOCUMENT_ID: Literal["worktree-review.review-policy/v1"] = (
    "worktree-review.review-policy/v1"
)
COMPUTE_POLICY_DOCUMENT_ID: Literal["worktree-review.compute-policy/v1"] = (
...
class ReviewPolicy(BaseModel):
    ...
    schema_name: Literal["worktree-review.review-policy/v1"] = Field(
        alias="schema",
...
class ComputePolicy(BaseModel):
    ...
    schema_name: Literal["worktree-review.compute-policy/v1"] = Field(
        alias="schema",
