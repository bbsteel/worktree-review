...
from mergegate.core.report import DimensionOutcome, StageStatus
from mergegate.core.workspace import ReviewWorkspace
from mergegate.schemas import DIMENSION_FINDINGS_SCHEMA_ID, load_schema
...
def dimension_system_prompt(dimension_id: str) -> str:
    ...
    return (
        "You are MergeGate reviewing an exact merge-candidate tree.\n"
