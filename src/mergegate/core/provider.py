...
from mergegate.core.errors import BudgetExhaustedError, ProviderError
from mergegate.core.policy import ComputePolicy, ProviderName
...
def build_provider(compute_policy: ComputePolicy) -> ProviderClient:
    ...
    if provider_name == "openai":
        from mergegate.core.providers.openai import OpenAIProvider

        return OpenAIProvider(model=compute_policy.model, api_key=_require_env("OPENAI_API_KEY"))
    from mergegate.core.providers.anthropic import AnthropicProvider
